...
function extractWebSession(sessionWrapper) {
    print("session - extractWebSession")
...
function clearWebSessionIdentifiers(sessionWrapper) {
    print("session - clearWebSessionIdentifiers")
}
...
function processMessageToMatchSession(sessionWrapper) {
    print("session - processMessageToMatchSession")
...
function getRequiredParamsNames() {
    print("session - getRequiredParamsNames")
...
function getOptionalParamsNames() {
    print("session - getOptionalParamsNames")
